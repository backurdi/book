<template>
  <div
    ...
    :key="index"
    class="flex p-4 w-full max-w-sm leading-normal bg-white border-b border-l border-r border-gray-400 rounded-b lg:flex lg:max-w-full lg:border-l-0 lg:border-t lg:border-gray-400 lg:rounded-b-none lg:rounded-r"
  >
    <img
      ...
      alt="book cover"
    />
    <img v-else class="mr-7 h-150 rounded" src="../../../assets/images/default-img.png" />
    <div class="w-full">
      <div class="mb-8">
