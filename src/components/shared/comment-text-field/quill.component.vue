<template>
  <div class="comment-input">
    ...
    <div class="flex-col w-full">
      ...
      <div v-if="toggleState" class="flex items-end justify-between mb-5 w-10/12">
    ...
    <button
      class="px-2 py-2 w-3/6 text-white text-sm font-bold bg-blue-500 hover:bg-blue-700 rounded"
      @click="emitBody"
    >
      {{ buttonText }}
    </button>
