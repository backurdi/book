    ...
    <form class="w-1/2">
      <div class="flex flex-wrap -mx-3 mb-6">
        <div class="mb-6 px-3 w-full md:mb-0 md:w-1/2">
          <label
            class="block mb-2 text-gray-700 text-xs font-bold tracking-wide uppercase"
            for="grid-first-name"
          >First Name</label>
          <input
            id="grid-first-name"
      ...
      <div class="flex flex-wrap -mx-3 mb-6">
        <div class="px-3 w-full">
          ...
          <input
            id="email"
            v-model="email"
            class="block mb-3 px-4 py-3 w-full text-gray-700 leading-tight bg-white focus:bg-white border focus:border-gray-500 border-white rounded focus:outline-none appearance-none"
            :class="{ 'border-red-500': emailError }"
            type="email"
          />
          <p v-if="emailError" class="text-red-500 text-xs italic">Please fill out this field.</p>
        </div>
      </div>
      <div class="flex flex-wrap -mx-3 mb-6">
        <div class="px-3 w-full">
          ...
          <textarea
            id="message"
            v-model="message"
            class="no-resize block mb-3 px-4 py-3 w-full h-48 text-gray-700 leading-tight bg-white focus:bg-white border focus:border-gray-500 border-white rounded focus:outline-none appearance-none resize-none"
            :class="{ 'border-red-500': messageError }"
          ></textarea>
          <p v-if="messageError" class="text-red-500 text-xs italic">Please fill out this field.</p>
        </div>
      </div>
      <div class="md:flex md:items-center">
        <div class="md:w-1/3">
          <button
            class="bg-teal-400 hover:bg-teal-400 focus:shadow-outline px-4 py-2 text-black hover:text-white font-bold hover:bg-readee bg-white rounded focus:outline-none shadow"
            type="button"
            @click="sendMessage"
          >Send</button>
        </div>
